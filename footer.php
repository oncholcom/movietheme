...
$fotext = cs_get_option('footertext');
$foclm1 = cs_get_option('footerc1');
$foclm2 = cs_get_option('footerc2');
$foclm3 = cs_get_option('footerc3');
$focopy = cs_get_option('footercopyright');
