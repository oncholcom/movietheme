...
defined('CS_OPTION')    or define('CS_OPTION', '_dooplay_options');
defined('CS_CUSTOMIZE') or define('CS_CUSTOMIZE', '_dooplay_customize');
...
/**
 * Framework Codestar Codex
 * @since 1.0.0
 * @version 1.0.0
 */
if( !function_exists('cs_codex_codestar') ){
    function cs_codex_codestar($app = 'framework', $codex = '64'){
        ...
        return apply_filters('cs_codex_codestar', $code2, $code1);
    }
}
